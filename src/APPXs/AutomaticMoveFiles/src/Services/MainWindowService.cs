...
namespace GSA.ToolKits.AutomaticMoveFiles.Services;
...
public sealed class MainWindowService
{
    ...
    public async Task<IEnumerable<string>> StartAsync(string paramString)
    {
        ...
        MoveFilesParam? param = JsonSerializer.Deserialize<MoveFilesParam>(paramString);
    ...
    private void ExcuteDeleteFiles(MoveFilesParam param, EnumerationOptions option, CancellationToken cancellation)
    {
        _isStarted = true;
