...
**本库主要致力于提供MinIO对象存储在.NET开发过程中的辅助与应用工具方法，使开发人员专注于业务逻辑与功能实现，降低项目耦合性，简化并提升工作效率，支持多种版本（netstandard2.0;netstandard2.1;net8.0;net9.0;net10.0;）。**
...
### 2025-12-17
- 修正BucketExistsAndCreateAsync方法判断逻辑，应为同时满足条件方可。

### 2025-12-04
- 判断并创建存储桶时，增加桶已存在的异处理，以避免异步高并发时出现此问题。
