...
**本库提供了中英双语等多个版本的数据分页助手类，多样性的数据分页功能，集成前端UI框架Bootstrap数据分页组件，契合微软MVC技术等，支持多种版本（netstandard2.0;netstandard2.1;net8.0;net9.0;net10.0;）。**
...
### 2024-12-28
- 样式文件中增加重写分页激活时样式，包括字体颜色、背景色、边框颜色；
- 去掉Bootstrap_V3和Bootstrap_V4支持，一切向钱看；
- 调整默认的分页大小范围，变更默认分页大小为15条记录。
