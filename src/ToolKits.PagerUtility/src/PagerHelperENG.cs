...
namespace DawnXZ.PagerUtility
{
    ...
    public class PagerHelperENG
    {
        ...
        public PagerHelperENG(int digitalpagesize)
        {
            this.PageCurrent = 1;
            this.PageCount = 0;
            this.PageSize = 40;
        ...
        /// <param name="digitalpagesize">数字分页—每页个数</param>
        public PagerHelperENG(int pagesize, int digitalpagesize)
        {
            this.PageCurrent = 1;
            this.PageCount = 0;
        ...
        /// <param name="pagesize">每页显示记录数</param>
        /// <param name="digitalpagesize">数字分页—每页个数</param>
        public PagerHelperENG(int pagecurrent, int pagecount, int pagesize, int digitalpagesize)
        {
            if (pagecurrent > -1)
            {
        ...
        /// <returns>HTML</returns>
        public string ShowPagerByScriptByForward(string urlPath, string parameter, bool outPageCount, bool showSelect, PagerType pagerType)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("<div id=\"pagerList\">");
            //分页数据信息
        ...
        /// <param name="pagerType">数据分页模式</param>
        /// <returns>HTML</returns>
        public string ShowPagerByScriptByNumeric(string urlPath, string parameter, bool outPageCount, PagerType pagerType)
        {
            //计算数字分页
            if (this.PageCount % this.DigitalPageSize == 0)
            {
        ...
        /// <param name="pagerType">数据分页模式</param>
        /// <returns>HTML</returns>
        public string ShowPagerByScriptByForwardOf(string parameter, bool outPageCount, bool showSelect, PagerType pagerType)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("<div id=\"pagerList\">");
            //分页数据信息
            ...
            {
                sb.AppendFormat("<a href=\"javascript:void(0);\" onclick=\"{0}(1,'{1}');\">First</a>", jsFunName, parameter);
            }
            //上一页
            if (this.PageCurrent <= 1)
            {
            ...
            {
                sb.AppendFormat("&nbsp;&nbsp;<a href=\"javascript:void(0);\" onclick=\"{0}({1},'{2}');\">Prev</a>&nbsp;&nbsp;", jsFunName, this.PageCurrent - 1, parameter);
            }
            //下一页
            if (this.PageCurrent >= this.PageCount)
            {
            ...
            {
                sb.AppendFormat("<a href=\"javascript:void(0);\" onclick=\"{0}({1},'{2}');\">Next</a>&nbsp;&nbsp;", jsFunName, this.PageCurrent + 1, parameter);
            }
            //末页
            if (this.PageCurrent == this.PageCount | this.PageCount == 0)
            {
            ...
            {
                sb.AppendFormat("<a href=\"javascript:void(0);\" onclick=\"{0}({1},'{2}');\">Last</a>", jsFunName, this.PageCount, parameter);
            }
            //页码选择器
            if (showSelect)
            {
        ...
        /// <param name="pagerType">数据分页模式</param>
        /// <returns>HTML</returns>
        public string ShowPagerByScriptByNumericOf(string parameter, bool outPageCount, PagerType pagerType)
        {
            //计算数字分页
            if (this.PageCount % this.DigitalPageSize == 0)
            {
