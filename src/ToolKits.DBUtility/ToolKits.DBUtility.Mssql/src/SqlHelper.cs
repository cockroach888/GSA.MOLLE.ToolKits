...
namespace GSA.ToolKits.DBUtility
{
    ...
    public sealed class SqlHelper
    {
        ...
        /// <para>instances from being created with "new SqlHelper()".</para>
        /// </summary>
        private SqlHelper() { }

        /// <summary>
        /// This method is used to attach array of SqlParameters to a SqlCommand.
        /// <para>This method will assign a value of DbNull to any parameter with a direction of</para>
        /// <para>InputOutput and a value of null.</para>
        /// <para>This behavior will prevent default values from being used, but</para>
        /// <para>this will be the less common case than an intended pure output parameter (derived as InputOutput)</para>
        /// <para>where the user provided no input value.</para>
        /// </summary>
