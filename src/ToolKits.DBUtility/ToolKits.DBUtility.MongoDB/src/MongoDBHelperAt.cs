...
//=========================================================================
// 文件名称：MongoDBHelperAt.cs
// 项目名称：数据库操作实用工具集
// 创建时间：2014-12-21 21:21:32
// 创建人员：宋杰军
// 负责人员：宋杰军
// 参与人员：宋杰军
// ========================================================================
...
namespace GSA.ToolKits.DBUtility
{
    ...
    /// </summary>
    public sealed class MongoDBHelperAt
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="handler">MongoDBHandler</param>
        public MongoDBHelperAt(MongoDBHandler handler)
        {
            this._db = handler.FDatabase;
        }
        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="db">MongoDatabase</param>
        public MongoDBHelperAt(MongoDatabase db)
        {
            this._db = db;
        }
        ...
        {
            string collectionName = typeof(T).Name; //集合名称
