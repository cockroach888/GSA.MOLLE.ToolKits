...
//=========================================================================
// 文件名称：JsonValueTupleConverterOfT4.cs
// 项目名称：魂哥常用工具集
// 创建时间：2022-09-18 14:21:12
// 创建人员：宋杰军
...
public sealed class JsonValueTupleConverter<T1, T2, T3, T4> : JsonConverter<ValueTuple<T1, T2, T3, T4>>
{
    /// <summary>
